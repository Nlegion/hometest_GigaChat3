...
Проект предоставляет простой диалоговый веб-интерфейс для интерактивного тестирования модели GigaChat3-10B-A1.8B-GGUF. Модель запускается через `llama-cpp-python` с поддержкой CUDA для ускорения на GPU.
